...
<!-- Modal -->
<div class="showModal" id="mainModal">
   <div class="card text-center text-white bg-secondary" style="width: 30rem; height: auto;">
      ...
      {:else}
         <h3 class="card-header">Updating Student</h3>
         <div class="card-body">
            <p class="card-text">
               Update student with uID: {uid}
            </p>
            ...
            <div class="input-group mb-3">
               ...
               <input type="text" class="form-control" bind:value={hairColor} />
            </div>
            <div class="buttons">
               <button class="btn btn-danger mx-3" style="width: 11rem;" on:click={handleClick}
                  ><strong>Cancel</strong></button
               >
               <button class="btn btn-primary mx-3" style="width: 11rem;" on:click={confirmUpdate}
